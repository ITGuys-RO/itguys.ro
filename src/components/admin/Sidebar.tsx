...
const navItems = [
  ...
  { href: '/admin/translations', label: 'Translations', icon: GlobeIcon },
];
    ...
    <aside className="w-64 min-h-screen bg-brand-900/80 border-r border-brand-700/50 backdrop-blur-sm">
      <div className="p-6">
        <Link href="/admin" className="flex items-center gap-3">
          ...
          <div>
            <div className="text-white font-semibold">ITGuys</div>
      ...
      <div className="px-6 py-4 border-t border-brand-700/50">
        <Link
          href="/"
          className="flex items-center gap-2 text-brand-400 hover:text-white text-sm transition-colors"
        >

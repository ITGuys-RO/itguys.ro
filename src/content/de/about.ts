...
export const aboutContent = {
  hero: {
    ...
    subheadline:
      "Über 25 Jahre kombinierte Erfahrung bei Electronic Arts, TUI, Nagarro und Schweizer Unternehmen. Web, Mobile und Sicherheit. In Rumänien ansässig, weltweit tätig.",
  },
  ...
  team: {
    ...
    members: [
      ...
      },
      {
        ...
        bio: "Über 10 Jahre Entwicklung nativer iOS- und Android-Apps. Zuvor bei Nagarro und Enea AB. Experte für Mobile-Architektur, IoT-Integrationen und CI/CD-Pipelines. Master in Informationssicherheit von der Politehnica Bukarest.",
